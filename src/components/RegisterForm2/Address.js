...
const Address = ({}) => {
  ...
  const selectProvince = () => {
    ...
    district.innerHTML =
      '<option value="default" disabled hidden>District</option>';
    subDistrict.innerHTML =
      '<option value="default" disabled hidden>Sub-district</option>';
    postalCode.value = '';
  ...
  const selectDistrict = () => {
    ...
    subDistrict.innerHTML =
      '<option value="default" disabled >Sub-district</option>';
    postalCode.value = '';
