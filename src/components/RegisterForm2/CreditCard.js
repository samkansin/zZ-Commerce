...
const CreditForm = () => {
  ...
  useEffect(() => {
    ...
    for (var i = num_year; i <= num_year + 10; i++) {
      cardYear.innerHTML =
        cardYear.innerHTML + "<option value='" + i + "'>" + i + "</option>";
    }
      ...
      <div className="card-form">
          ...
          <div className="card-item">
            ...
            <div className="card-item__side front">
              ...
              <div className="card-item__cover">
                <img
                  src="https://raw.githubusercontent.com/muhammederdem/credit-card-form/master/src/assets/images/24.jpeg"
                  alt=""
        ...
        <div className="card-form__inner">
          <div className="card-input form">
            <div className="tool">
              Credit card number 16 digit, must start with 51, 52, 53, 54 or 55
            </div>
          ...
          <div className="card-form__row">
            <div className="card-form__col form">
              <div className="tool">Must not expired</div>
            ...
            <div className="card-form__col CVC">
              <div className="card-input form">
                ...
                <label htmlFor="cardCVC" className="card-input__label">
                  CVC
                </label>
                <input
                  type="password"
