...
//Toast Notification
const invalidAge = () => toast.warn("Invalid age", {
    position: "top-center",
    autoClose: 1000,
...
const invalidFullName = () => toast.warn("Invalid name", {
    position: "top-center",
    autoClose: 1000,
    hideProgressBar: false,
    closeOnClick: true,
...
const invalidDisplayName = () => toast.warn("Invalid display name", {
    position: "top-center",
    autoClose: 1000,
    hideProgressBar: false,
    closeOnClick: true,
...
const invalidGender = () => toast.warn("Please select your sex", {
    position: "top-center",
    autoClose: 1000,
    hideProgressBar: false,
    closeOnClick: true,
...
const invalidPhoneNum = () => toast.warn("Invalid phone number", {
    position: "top-center",
    autoClose: 1000,
    hideProgressBar: false,
    closeOnClick: true,
...
const RegisterForm2 = () => {
    ...
    const handleSubmit3 = () => {
        ...
        if(address == "" || road == "" || postalCode == "" || subDistrict == "" || district == "" || province == ""){
