...
const Addresscheckout = ({ refreshCart, cart, products }) => {
    ...
    get(child(ref(db), `addressInfo/${uid}`)).then((snapshot) => {  // might change the directory to shippingAddress
        if (snapshot.exists()) {
            const province = document.querySelector('#province');
            const district = document.querySelector('#district');
            const subDistrict = document.querySelector('#sub_district');
    ...
    get(child(ref(db), `personalInfo/${uid}`)).then((snapshot) => {  // might change the directory to shippingAddress
        if (snapshot.exists()) {
            // example
                    ...
                    cart.line_items.forEach((ele) => {
                        ...
                        products.forEach((product) => {
                            if(product.id == ele.product_id){
                                ...
                                set(ref(db, 'transaction/' + uid + "/" + cart.id.slice(5) + "/" + ele.product_id.slice(5)), {
                    ...
                    <div className="content">
                        <div className="line1">
                            <div className="fullname form">
                                <div className="tool">
                                    Enter a full name in English or Thai
                                </div>
                                <span className="title">Full Name</span>
                                <input type="text"  className="form-controler" placeholder="Full Name" id="fullname"/>
                            </div>
                            ...
                            <div className = "phonenumber form">
                                ...
                                <input type="number"  className="form-controler" placeholder="Phone Number" id="phoneNumber"/>
                            </div>
                        </div>
                        ...
                        <div className="line2">
                            <div className = "Address form">
                                ...
                                <textarea type="text"  className="form-controler" placeholder="Village,Village No,Alley,Lane,Sub-area" id="address"/>
                            </div>
                        </div>
                        ...
                        <div className="line3">
                            <div className="road form">
                                ...
                                <input type="text"  className="form-controler" placeholder="Road" id="road"/>
                            </div>
                            ...
                            <div className="sub-district form">
                                ...
                                <select className="form-controler" id="sub_district" placeholder="Sub-district" onChange={selectSubDistrict}>
                            ...
                            <div className="district form">
                                ...
                                <select className="form-controler" id="district" placeholder="District" onChange={selectDistrict}>
                        ...
                        <div className="line4">
                            ...
                            <div className="postal form">
                                ...
                                <input type="number"  className="form-controler" placeholder="Postal Code" id="postalCode"/>
                            </div>
                        </div>
