          ...
          Object.keys(snapshot.val()[key]).forEach((val) => {
            if (val != "date") {
              itemList +=
                ...
                '<div class="order_img">' +
                '<img src="' +
                snapshot.val()[key][val].picture +
                '"></img>' +
                '<span class="ea">' +
                snapshot.val()[key][val].quantity +
                "</span>" +
                "</div>" +
                '<div class="item">' +
                '<span class="name">' +
                snapshot.val()[key][val].name +
                "</span>" +
                '<span class="description_item">' +
                snapshot.val()[key][val].description +
                "</span>" +
                "</div>" +
                '<span class="price">' +
                snapshot.val()[key][val].total +
                " THB</span>" +
                "</div>" +
                "</div>" +
                "</div>" +
